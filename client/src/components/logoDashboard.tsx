...
export const LogoDashboard = () => {
    ...
    return (
        <>
            <div style={{ paddingLeft: '0' }} className="w-full border-b flex flex-col items-start md:flex-row justify-between md:items-center">
                <div>
                ...
                <div className="flex px-5 pb-2 md:p-0 items-center gap-2">
                    <div className="p-3 w-12 h-12 bg-blue-700 text-white font-semibold text-xl overflow-hidden border-white border rounded-full relative">
                        <div className="absolute w-full h-full top-0 flex justify-center items-center left-0">
